...
* A difference of income = 0.33 on the logit scale. As an example we can find the difference in probability near the mean income (about 3): 
...
c) Looking at fit_3, what are the important variables? Disucss during meeting.
