...
Example: $\text{earnings}=11000 + 1500*(\text{height}-60) + \text{error}$ where the error has standard deviation $22000$
...
- *Casual inference* is questionable as short and tall people differ in many ways.
