...
* Return to the Beauty and sex ration example (from 9.4-9.5).  
...
* Example using a randomized experiment on 100 students designed to test an intervention for improving scores.
   ...
   - Assumes intervention effect is a 5 point addition to teh students score. 
   - Final exam score are assumed ot be random with mean 60 and standard deviation 20
